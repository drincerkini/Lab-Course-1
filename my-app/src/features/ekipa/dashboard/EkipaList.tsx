    ...
    <>
        ...
        <div className="container">
            <div className="block__top">
                <span className="block__help-txt"><Button icon="add" content='Add team member' floated="right" as={Link} to='/createEkipa' size="tiny" /></span>
                <h2 className="block__title">Our Team Members</h2>
            </div>
            ...
            <div className="swiper swiper-testimonial" key={ekipa.id}>
                ...
                <div className="swiper-wrapper" >
                          ...
                          <div className="swiper--testimonial__person">
                              ...
                              <span className="block__help-txt"><Button icon="edit" content='Edit' floated="right" as={Link} to='/editEkipa' size="tiny" /></span>

                              <span className="block__help-txt"><Button icon="delete" content='Delete' floated="right" as={Link} to='/deleteEkipa' size="tiny" /></span>
